app.controller('HomageCtrl', ['$scope', '$mdToast', '$ionicPlatform', '$ionicLoading', '$ionicSlideBoxDelegate', '$ionicScrollDelegate', '$ionicPopup', '$cordovaNetwork', '$cordovaDevice', 'CONSTANTS', 'HomageFactory', 'AchievementFactory', 'AvatarFactory', 'TimerFactory', function ($scope, $mdToast, $ionicPlatform, $ionicLoading, $ionicSlideBoxDelegate, $ionicScrollDelegate, $ionicPopup, $cordovaNetwork, $cordovaDevice, CONSTANTS, HomageFactory, AchievementFactory, AvatarFactory, TimerFactory) {
    'use strict';
    ...
    var controller = {
        init: function () {
            ...
            if (ionic.Platform.isAndroid()) {
                ...
                this.setup($scope.data.uuid);
                $scope.data.popupEnabled = false;
            } else {
                if (!window.cordova) {
                    _popupUsername = $ionicPopup.show({
                ...
                var that = this;
                _popupUsername.then(function (input) {
                    // Setup the loader
                    $ionicLoading.show({
                        content: 'Loading',
                        animation: 'fade-in',
    ...
    $ionicPlatform.ready(function () {
        ...
        _isAvailable = ionic.Platform.device().available;
