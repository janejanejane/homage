app.factory('HomageFactory', ['$firebaseArray', '$firebaseObject', '$http', 'CONSTANTS', 'AchievementFactory', function ($firebaseArray, $firebaseObject, $http, CONSTANTS, AchievementFactory) {
    'use strict';
